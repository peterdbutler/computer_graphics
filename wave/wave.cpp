// ======================================================================
//
// wave.cpp - Wave simulation program.
//
// Written by: George Wolberg, 2012
// ======================================================================
//

// This program has a couple of wave simulation features:
//
...
// Left mouse rotates the scene, middle mouse or +/- keys zoom, right mouse for menu.
...
void loadImageTexture(void)
{
    ...
    readPPM("texmap.ppm", ww, hh, texData);
    ...
    // read second texture
    readPPM("envmap.ppm", ww, hh, texData);
