...
// HW4b constructor.
//
HW4b::HW4b(const QGLFormat &glf, QWidget *parent)
	: HW(glf, parent)
{
	m_timer = new QTimer(this);
	connect(m_timer, SIGNAL(timeout()), this, SLOT(moveLight()));
	m_biasMatrix(0, 0) = 0.5f; m_biasMatrix(0, 1) = 0.0f; m_biasMatrix(0, 2) = 0.0f; m_biasMatrix(0, 3) = 0.5f;
	m_biasMatrix(1, 0) = 0.0f; m_biasMatrix(1, 1) = 0.5f; m_biasMatrix(1, 2) = 0.0f; m_biasMatrix(1, 3) = 0.5f;
	m_biasMatrix(2, 0) = 0.0f; m_biasMatrix(2, 1) = 0.0f; m_biasMatrix(2, 2) = 0.5f; m_biasMatrix(2, 3) = 0.5f;
	m_biasMatrix(3, 0) = 0.0f; m_biasMatrix(3, 1) = 0.0f; m_biasMatrix(3, 2) = 0.0f; m_biasMatrix(3, 3) = 1.0f;
	reset();
}
...
HW4b::initShaders()
{
	...
	initShader(DEPTHMAP_SHADER,
		   QString(":/hw4/vshader4b1.glsl"),
		   QString(":/hw4/fshader4b1.glsl"),
		   uniforms);
	...
	initShader(SHADOW_SHADER,
		   QString(":/hw4/vshader4b2.glsl"),
		   QString(":/hw4/fshader4b2.glsl"),
		   uniforms);
	...
	initShader(TEXTURE_SHADER,
		   QString(":/hw4/vshader4b3.glsl"),
		   QString(":/hw4/fshader4b3.glsl"),
		   uniforms);
}
...
void
HW4b::GetShadowMapExtends(vec3 &extends) {
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// HW4b::mousePressEvent:
//
// Mouse press event handler.
//
void 
HW4b::mousePressEvent(QMouseEvent *e)
{
...
//
void 
HW4b::mouseMoveEvent(QMouseEvent *e)
{
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// HW4b::mouseWheelEvent:
//
// Mouse wheel event handler.
// allow to zoom in/out in the scene
//
void
HW4b::wheelEvent(QWheelEvent *event) 
{
